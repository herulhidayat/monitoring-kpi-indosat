    ...
    <div class="page-info">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Site Serious Customer</li>
            </ol>
        </nav>
    </div>
                        ...
                        <table class="table table-bordered data-table" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="5">Site Serious Customer</th>
                                </tr>
                                <tr>
                                    <th>Target</th>
                                    <th>Ach</th>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        processing  : true,
        serverSide  : true,
        ajax: "{{ route('kpi-data.ssc') }}",
        columns: [
            {data: 'username', name: 'username'},
            {data: 'nama', name: 'nama'},
            {data: 'micro_cluster', name: 'micro_cluster'},
            {data: 'ssc_target', name: 'ssc_target'},
            {data: 'ssc_ach', name: 'ssc_ach'},
            {data: 'ssc_gap', name: 'ssc_gap'},
            {data: 'ssc_percen', name: 'ssc_percen'},
